...
<p align="center">Rizz Multi Device</p>
<div align="center">
<img src="https://pbs.twimg.com/media/FWg8fTBUEAA2VEy?format=jpg&name=large" width="150" height="150" border="0" alt="PFFP">

<br> Gunakan dengan risiko Anda sendiri!

[![Check Error](https://github.com/RizzyDev81/rizz-multidevice/actions/workflows/node.js.yml/badge.svg)](https://github.com/RizzyDev81/rizz-multidevice/actions/workflows/node.js.yml)
...
Contoh Command : [`./command/umum/help.js`](https://github.com/RizzyDev81/rizz-multidevice/blob/main/command/umum/help.js)<br />
...
Isi semua yang dibutuhkan di file [`config.json`](https://github.com/RizzyDev81/rizz-multidevice/blob/main/config.json)<br />
...
> pkg install nodejs
> git clone --depth=1 https://github.com/RizzyDev81/rizz-multidevice/
> cd rizz-multidevice
...
-   [`RizzyDev81`](https://github.com/RizzyDev81)
